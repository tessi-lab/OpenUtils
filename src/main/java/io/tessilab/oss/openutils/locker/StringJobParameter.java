...
/**
 * The simpliest job parameter that has only a string create when the object is
 * instancieted. 
 * @author Andres BEL ALONSO
 */
public class StringJobParameter implements JobParameter{
    
    private String descriptionParameter;

    public StringJobParameter(String descriptionParameter) {
